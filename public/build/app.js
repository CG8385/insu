...
angular.module('app.employee').controller('RecorderEditorController', function ($scope, $filter, $rootScope, $state, $stateParams, EmployeeService) {
    var vm = this;
    vm.user = {};
    vm.editable = false;
    vm.organizations=[];
    ...
    if ($state.is("app.employee.recorder.new")) {
        vm.editable = true;
    }
    ...
    vm.submit = function () {
        ...
        EmployeeService.saveUser(vm.user)
            .then(function (data) {
                ...
                vm.user = {};
                if (vm.back) {
                    $state.go("app.employee.recorder");
                }
            }, function (err) { });
    };
