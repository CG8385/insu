...
angular.module('app.policy').controller('PropertyPolicyEditorController', function ($scope, $filter, $rootScope, $state, $stateParams, PropertyPropertyPolicyService, ngDialog) {
    var vm = this;
    var defaultPolicy = {
        payment_addition: 0,
