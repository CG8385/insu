    ...
    ['$q', '$http', 'uuid',
        function ($q, $http, uuid) {
            ...
            */
            ...
            function searchPolicies(currentPage, pageSize, type, filterSettings, fromDate, toDate,approvedFromDate, approvedToDate, paidFromDate, paidToDate, swipedFromDate, swipedToDate, policyNoSearch=undefined) {
                // create a new instance of deferred
                var deferred = $q.defer();
            ...
            function getFilteredCSV(type, filterSettings, fromDate, toDate,approvedFromDate, approvedToDate, paidFromDate, paidToDate, swipedFromDate, swipedToDate, policyNoSearch=undefined) {
                // create a new instance of deferred
                var deferred = $q.defer();
                var orderBy = "submit_date";
                var orderByReverse = true;
