...
var schema = new mongoose.Schema({
  ...
  sub_policies: [{ insurant: String, product: { type: mongoose.Schema.Types.ObjectId, ref: 'LifeProduct' }, year: String, fee: Number, income_rate: Number,income: Number,supplementary_agreement_rate:Number,supplementary_agreement:Number,direct_payment_rate: Number, direct_payment: Number,class_payment_rate: Number, class_payment: Number}],
  total_income: Number,
  total_supplementary_agreement : Number,
  profit : Number,
  taxed_profit : Number,
